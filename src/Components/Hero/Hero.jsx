                                ...
                                <div className='grid grid-cols-1 sm:grid-cols-2'>
                                    <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                                        ...
                                        <div data-aos='fade-up' data-aos-duration='500' data-aos-delay='300'>
                                            <Link to="/d-cart/top_rated"><button onClick={() => { props.handleOrderPopup }} className='bg-gradient-to-r from-primary to-secondary hover:scale-105 duration-200 text-white py-2 px-2 rounded-full'>Order Now</button></Link>
                                        </div>
                                    </div>
