...
const DisplayProduct = (props) => {
    ...
    return (
        <div className='container mb-10'>
            <div className='bg-primary/40 rounded-md grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-10 items-center'>
                <div className=''>
                ...
                <div className='container pb-4'>
                    ...
                    <div className='flex mt-2 flex-col gap-2'>
                        ...
                        <button data-aos="fade-up" className='bg-primary hover:scale-105 duration-300 text-white py-1 px-4 rounded-full mt-4 hover:bg-white hover:text-primary'>Order Now</button>
